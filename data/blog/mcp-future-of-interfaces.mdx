...
You tell the computer _how_ to do something. Click File → New → Spreadsheet → Format → Add Column → Name it "Revenue"...

**Intent-based computing (new model):**
You tell the computer _what_ you want. "Create a spreadsheet tracking monthly revenue by product line."
