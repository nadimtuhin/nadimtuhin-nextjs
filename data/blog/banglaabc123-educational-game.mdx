...
tags: ['games', 'project', 'react', 'education', 'open-source']
draft: false
---
...
My children were struggling to memorize numbers in both English and Bengali scripts. Traditional study methods felt tedious, and I noticed they were far more engaged with mobile games than textbooks.
...
I'm actively working on adding more features based on feedback from my kids and other parents.
...
If you have ideas or want to contribute to making learning more fun for children, I'd love to hear from you.

---

## Resources

- [Play the game](https://bangla-abc-123.vercel.app)
- [GitHub Repository](https://github.com/nadimtuhin/BanglaABC123)
